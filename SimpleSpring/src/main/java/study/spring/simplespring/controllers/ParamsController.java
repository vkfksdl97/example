...
public class ParamsController {
	...
	public String get(Model model, @RequestParam(value="answer", defaultValue="0") int ans) {
		String result = null;
	...
	public String path1(Model model, @PathVariable String txt1, @PathVariable String txt2, @PathVariable int num) {
		// 파라미터값을 View에게 전달한다.
