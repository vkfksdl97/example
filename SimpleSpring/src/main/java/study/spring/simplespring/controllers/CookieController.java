...
public class CookieController {
	/**
	 * 쿠키 저장을 위한 작성 페이지 --> 이 페이지를 "/cookie/write.do" URL에 GET 방식으로 노출시킨다.
	 */
	...
	public String cookieWrite(Model model,
		...
		try {
			// 저장시에 URLEncoding 이 적용되었으므로 URLDecoding이 별도로 필요함
	...
	/**
	 * 쿠키를 저장하기 위한 action 페이지 --> 이 페이지를 "/cookie/sava.do" URL에 POST 방식으로 노출시킨다.
	 */
