...
public class SessionController {
	/**
	 * 세션 저장을 위한 작성 페이지 --> 이 페이지를 "/session/write.do" URL에 GET 방식으로 노출시킨다.
	 */
	...
	/**
	 * 세션을 저장하기 위한 action 페이지 --> 이 페이지를 "/session/save.do" URL에 POST 방식으로 노출시킨다.
	 */
	...
	public String sessionSave(HttpServletRequest request,
		...
		/** 3) Spting 방식의 페이지 이동. */
		// Servlet의 response.sendRedirect(url) 과 동일 --> "/" 부터 시작할 경우 ContextPath는 자동으로 앞에 추가된다.
