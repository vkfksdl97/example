...
<body>
	...
	<div>
		<a href="${pageContext.request.contextPath}/params/path1/hello/world/1234">hello/world/1234</a>
	</div>
	<div>
		<a href="${pageContext.request.contextPath}/params/path2/foo/bar/5678">foo/bar/5678</a>
	</div>
</body>
</html>